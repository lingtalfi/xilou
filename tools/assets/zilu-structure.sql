...
-- Schema zilu
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `zilu` DEFAULT CHARACTER SET utf8 ;
USE `zilu` ;
...
CREATE TABLE IF NOT EXISTS `zilu`.`fournisseur_has_article` (
  ...
  `volume` DECIMAL(10,10) NULL,
  `poids` DECIMAL(10,10) NULL,
...
CREATE TABLE IF NOT EXISTS `zilu`.`devis` (
  ...
  `fournisseur_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_devis_fournisseur1_idx` (`fournisseur_id` ASC),
...
CREATE TABLE IF NOT EXISTS `zilu`.`devis_has_commande_has_article` (
  ...
  `commande_has_article_id` INT NOT NULL,
  PRIMARY KEY (`devis_id`, `commande_has_article_id`),
  INDEX `fk_devis_has_commande_has_article1_commande_has_article1_idx` (`commande_has_article_id` ASC),
  INDEX `fk_devis_has_commande_has_article1_devis1_idx` (`devis_id` ASC),
  CONSTRAINT `fk_devis_has_commande_has_article1_devis1`
    FOREIGN KEY (`devis_id`)
    REFERENCES `zilu`.`devis` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_devis_has_commande_has_article1_commande_has_article1`
    FOREIGN KEY (`commande_has_article_id`)
    REFERENCES `zilu`.`commande_has_article` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `zilu`.`historique_statut`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zilu`.`historique_statut` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `date` DATETIME NOT NULL,
  `statut_nom` VARCHAR(64) NOT NULL,
  `reference_lf` VARCHAR(64) NOT NULL,
  `fournisseur_nom` VARCHAR(64) NOT NULL,
  `reference_fournisseur` VARCHAR(64) NOT NULL,
  `commande_reference` VARCHAR(64) NOT NULL,
