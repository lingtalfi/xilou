...
CREATE TABLE IF NOT EXISTS `zilu`.`devis_has_commande_has_article` (
  ...
  INDEX `fk_devis_has_commande_has_article_commande_has_article1_idx` (`commande_has_article_commande_id` ASC, `commande_has_article_article_id` ASC),
  INDEX `fk_devis_has_commande_has_article_devis1_idx` (`devis_id` ASC),
...
CREATE TABLE IF NOT EXISTS `zilu`.`historique_statut` (
  ...
  `commande_nom` VARCHAR(64) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
