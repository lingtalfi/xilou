                ...
                <tr>
                    <td align="left" class="titleblock" style="padding:7px 0">
                        <font size="3" face="Open-sans, sans-serif" color="#555454">
                            <span class="title">Hi,</span><br/>
                            <span class="subtitle">
                                I'm Zilu.<br>
                                I'm responsible for ordering products for Leaderfit (the company where I work in France).<br><br>

                                We are interested in buying some of your products.
                                <br>
                                Could you please check the list below and tell me if you see any problem (quantity not available, price errors, ...)?
                                <br><br>
