...
if (count($list) > 0) {
    ...
    if (null !== $targetPath) {
        ...
        $statIsInstalled = CounterUtil::isInstalled($targetPath);


        if (false === $statIsInstalled) {
            ...
            if (null === $error) {
                ...
                $cacheDir = $targetPath . '/' . CounterConfig::statsCacheDirName();
                $data = $analyzer
        ...
        <?php if (true === $statIsInstalled && true === $hasData): ?>
