...
class ProPurchaseOrderInvoiceModel extends LingAbstractModel
{
    ...
    public function prepareByCommandeIdFournisseurId($commandeId, $fournisseurId)
    {

        if (false !== ($orderRef = CommandeUtil::getReferenceById($commandeId))) {
            ...
            throw new \Exception("Cannot find info for commande #" . $commandeId);
        }
        return $this;
    }
