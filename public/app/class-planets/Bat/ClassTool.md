...
rewriteMethodContentByFile
--------------------------
2017-01-02


```php
void    rewriteMethodContentByFile (string:file, string:method, callable:func)

```

Replace the content of a class which file is given.
The "func" callable receives an array of lines passed by reference.

 
```php
$file = '/path/to/Events/EventsServices.php';
$method = 'onPageRenderedAfter';
ClassTool::rewriteMethodContentByFile($file, $method, function(array &$lines){
    $lines[] = "doo();";
});
``` 
